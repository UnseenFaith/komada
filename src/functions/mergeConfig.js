...
exports.validate = (options) => {
  ...
  if ("permStructure" in options) {
    if (options.permStructure instanceof PermLevels || !Array.isArray(options.permStructure)) throw new TypeError("PermStructure must be a valid array with 11 entries, or a instance of Komada.PermLevels");
  }
  if ("selfbot" in options && typeof options.selfbot !== "boolean") throw new TypeError("Selfbot must be true or false.");
  if ("readyMessage" in options && typeof "readyMessage" !== "function") throw new TypeError("ReadyMessage must be a function.");
