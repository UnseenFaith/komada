exports.run = async (client, msg) => {
  const information = [
    ...
    "• \"Finalizers\" wich run on messages after a successful command.",
    "• \"Extendables\", code that acts passively. They add properties or methods to existing Discord.js methods.",
